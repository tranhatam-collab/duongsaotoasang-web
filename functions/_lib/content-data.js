export const POST_CONTENTS = [
  ...
  },
  {
    ...
    content_vi: `
      ...
      <p>Giai đoạn nền móng của DSTS tập trung vào những việc căn bản: trang chủ phải giải thích toàn bộ dự án; các trang giới thiệu, chương trình, liên hệ, gây quỹ, minh bạch và pháp lý phải có nội dung thật; thư viện bài viết phải có fallback đầy đủ; trang chi tiết nội dung phải trả về bài viết thật hoặc lỗi 404 rõ ràng; sitemap, RSS, canonical và kiểm thử triển khai phải chạy được trên production.</p>
    ...
    content_en: `
      ...
      <p>The DSTS foundation stage focuses on basics: the homepage must explain the project; about, program, contact, donate, transparency, and legal pages must contain real content; the article library must have complete fallback; content detail pages must render a real article or a clear 404; sitemap, RSS, canonical tags, and production verification must work.</p>
  ...
  },
  {
    ...
    content_vi: `
      ...
      <h2>Điều kiện mở bảo vệ người dùng và team</h2>
      <p>Mỗi cổng Movement cần có điều kiện mở riêng. Events cần owner, status, venue hoặc hình thức rõ ràng, và post-event report. Sponsors cần pricing lock, legal agreement, money-lane firewall và fulfillment tracker. Diaspora Map cần privacy review, k-anonymity và không hiển thị trẻ em. Press và Partners cần quyền dùng tên, logo, boilerplate và thông tin public đã duyệt.</p>
      <p>Khi các điều kiện này được giữ nghiêm túc, team dev không phải đoán. Người đọc không bị dẫn nhầm. Founder có thể nhìn thấy phần nào đang live, phần nào còn blocked và phần nào cần quyết định tiếp theo. Movement Portal vì vậy không chỉ là trang cộng đồng, mà là một hệ thống công bố trạng thái có trách nhiệm.</p>
    `,
    content_en: `
      ...
      <h2>Opening criteria protect users and the team</h2>
      <p>Every Movement surface needs its own opening criteria. Events need owner and status. Sponsors need legal and fulfillment boundaries. Diaspora Map needs privacy review and k-anonymity. Press and Partners need rights to names, logos, and public claims.</p>
      <p>When these criteria are respected, developers do not have to guess, readers are not misled, and the Founder can see what is live, what is blocked, and what needs the next decision.</p>
    `,
