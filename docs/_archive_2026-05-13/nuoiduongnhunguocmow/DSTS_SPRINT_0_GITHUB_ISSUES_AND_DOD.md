...
| # | Title | Files chính | Effort | Day | Depends on |
|---|---|---|---|---|---|
| 01 | Fix routing + `_redirects` | `_redirects` | 2h | 1 | — |
| 02 | Build designed 404 page | `404.html` | 1.5h | 1 | 01 |
| 03 | Build posts fallback | `posts.html`, `/data/posts.json` | 3h | 1 | 01 |
| 04 | Build content fallback 5 states | `content.html`, `/data/content.json` | 3h | 1 | 01 |
| 05 | Build contact page | `contact.html` | 2h | 1 | 01 |
| 06 | Build donate page | `donate.html` | 2h | 1 | 01 |
| 07 | Build transparency page | `transparency.html` | 1.5h | 1 | 01 |
| 08 | Add legal + payment disclaimer | `legal.html`, `scripts/*.html` | 3h | 2 | 01 |
| 09 | Smoke test script | `scripts/smoke-test.sh` | 1h | 3 | tất cả |
...
# Reserve cho Layer 1/2 (sẽ build sau Sprint 4)
