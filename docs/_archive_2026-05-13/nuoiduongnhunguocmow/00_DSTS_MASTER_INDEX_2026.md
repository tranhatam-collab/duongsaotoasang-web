...
```
LAYER 2 — Star Journey OS               (Tháng 11/2026+)
  Hệ sản phẩm tự động cá nhân hóa hành trình tỏa sáng
  ↑
LAYER 1 — Movement Portal               (Tháng 7-10/2026)
...
| **Layer 1 — Movement Portal** | 🔵 Spec đang viết | n/a | Founder + Claude | 2026-09-30 |
| **Layer 2 — Star Journey OS** | 🔵 Spec đang viết | n/a | Founder + Claude | 2027-02-28 |
| **Layer A — Drive vision gốc** | ✅ Đã có tài liệu | n/a | Founder | — |

**Quy tắc gate:**
- Layer 0 phải đạt 100/100 trước khi mở Layer 1
...
| A7 | KẾ HOẠCH DỰ KIẾN VÀ TÊN CHƯƠNG TRÌNH ĐẦU TIÊN | [link](https://docs.google.com/document/d/1yrKhNeDdUCW6cLpjPoeYJwJikMquqoWFRlh0N7kK1xQ/edit) | ⚠️ Cần update | Sự kiện dự kiến 22/01/2026 — đã qua, cần xác nhận trạng thái |
...
|---|---|---|---|---|
| 5.1.1 | `dsts-master-plan-v1.1-LOCKED.md` | Master plan 4 tuần, 8 trụ rubric, 100/100 | 🔒 Locked 2026-05-12 | Founder + Claude |
| 5.1.2 | `DSTS_SPRINT_0_GITHUB_ISSUES_AND_DOD.md` | 9 GitHub Issues cho Sprint 0 | 🔒 Locked 2026-05-12 | Tech Lead |
| 5.1.3 | `dsts-bug-report.md` | Audit ban đầu 2026-05-12 | ✅ Reference | Claude |
| 5.1.4 | `dsts-drive-gap-analysis-v2.md` | Gap analysis từ Drive | ✅ Reference | Claude |
...
🔵 Sau Layer 0 — Layer 1 (Tháng 7-10):
  18. /movement/sponsors landing page
  19. /movement/events calendar
  20. /movement/diaspora-map
  21. Sponsorship form + manual confirmation flow
  22. Pitch Deck PDF (song ngữ)
  23. Press Kit

🔵 Sau Layer 1 — Layer 2 (Tháng 11+):
...
| **AI Assistant** | Claude (em) | Spec, plan, docs, gap analysis |
...
1. Đọc `dsts-master-plan-v1.1-LOCKED.md` (toàn cảnh)
...
1. Lock `dsts-master-plan-v1.1-LOCKED.md`
2. Chỉ định Tech Lead + Content Writer
3. Trả lời 6 câu trong `dsts-drive-gap-analysis-v2.md` Mục VI để Claude finalize Layer 1/2 spec
4. Review + ký Gate 3 sau khi Sprint 0 hoàn thành
