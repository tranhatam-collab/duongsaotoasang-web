...
> **v1.5.25 changes:** Remove internal launch/development jargon (`Sprint 0`, `Founder Lock`, public `release gate`) from user-facing pages/articles, and block those regressions in depth QA.
...
**Founder:** Trần Hà Tâm
**Phiên bản:** v1.5.25 (master index — pending re-lock)
...
🟡 Sprint 1-4 — 3 tuần tiếp:
  ...
  33. public wording guardrail ✅ user-facing pages/articles no longer expose internal `Sprint 0`, `Founder Lock`, or public `release gate` jargon; depth QA blocks regressions 2026-05-14
...
| v1.5.25 | 2026-05-14 | Remove internal launch/development jargon (`Sprint 0`, `Founder Lock`, public `release gate`) from user-facing pages/articles, update smoke markers, and block those phrases in static/content depth QA. | Codex |
